<div>
    ...
    @endif --}}
    @if (($result == "Noseleccionoalmacen") || ($vercontent == 1 && $codalm == '0'))
        <div class="alert alert-danger">
            <strong>No se ha seleccionado el codigo del almacen.</strong>
        </div>
    @endif
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div>
                ...
                class="btn btn-warning mb-3 ml-2 mr-1 d-inline float-right">
                Ver Contenido</a>
                {{-- <a href="{{route('almacen.create')}}"
                class="btn btn-warning mb-3 ml-2 mr-1 d-inline float-right">Mover Contenido</a> --}}
            </div>
        </div>
    </div>
