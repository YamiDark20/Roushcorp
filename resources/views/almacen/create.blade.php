...
@section('content_header')
    ...
    <nav aria-label="breadcrumb" class="mb-2">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="">Mover Contenido</a></li>
        </ol>
    </nav>
    ...
    <h1>Movilizar contenido de un Almacen</h1>
@stop
...
@section('content')
    <div class= "col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                @livewire('mover-contenido-almacen')
            </div>
        </div>
    </div>
@stop
